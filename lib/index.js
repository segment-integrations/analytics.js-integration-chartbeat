...
var Chartbeat = module.exports = integration('Chartbeat')
  ...
  .option('uid', null)
  .option('video', false)
  .option('subscriberEngagementMappings', {})
...
Chartbeat.prototype.updateConfig = function(page) {
  ...
  for (var key in props) {
    ...
    if (key in this.options.subscriberEngagementMappings) {
      _cbq.push([this.options.subscriberEngagementMappings[key], props[key]]);
    }
  }
};
